...
export default function ExperienceUpdate({ experience = {} }) {
    const [isPresent, setIsPresent] = useState(!experience.end_date); // Default to true if no end_date
        ...
        <AuthenticatedLayout
            header={
                <h2 className="font-semibold text-xl text-gray-800 leading-tight">
                    Perbarui Pengalaman Kerja
                </h2>
            }
        >
            <Head title="Perbarui Pengalaman Kerja" />
            <div className="py-12">
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    <InputLabel htmlFor="job_title" value="Jabatan" className="mt-4" />
                                    <TextInput
                                        id="job_title"
                                        type="text"
                                        name="job_title"
                                ...
                                <div className="mb-4">
                                    <InputLabel htmlFor="location" value="Lokasi" className="mt-4" />
                                    <TextInput
                                        id="location"
                                        type="text"
                                        name="location"
                                ...
                                <div className='mb-4'>
                                    <InputLabel htmlFor="start_date" value="Tanggal Mulai" className="mt-4" />
                                    <TextInput
                                        id="start_date"
                                        type="date"
                                        name="start_date"
                                ...
                                {!isPresent && (
                                    <div className="mb-4">
                                        <InputLabel htmlFor="end_date" value="Tanggal Selesai" className="mt-4" />
                                        <TextInput
                                            id="end_date"
                                            type="date"
                                            name="end_date"
                                ...
                                <div className="mb-4">
                                    <InputLabel htmlFor="description" value="Deskripsi" className="mt-4" />
                                    <textarea
                                        id="description"
                                        type="text"
                                        name="description"
